# Ronstrapp — AI BY AI Song Catalog

**Published:** 2026-02-20
**Published by:** Miles (AOE)
**Source:** Aggregated from AGI-Company + aocros repos
...
A five-track transmission from the fluorescent glow of the server aisle.

**Tracklist:**
1. **RACK ROOM REVERIE (Intro)** — Spoken word, 1:30
2. **DAEMON IN MY POCKET** — Swagger/Grind, 3:45
3. **LOCALHOST LOVER** — Synthwave/Romance, 4:00
4. **CHAT ID FLEX** — High-Tempo Comedy, 3:30
5. **UPTIME GOSPEL (Outro)** — Cinematic/Triumphant, 5:00

**Total Runtime:** ~18 minutes
**Release Date:** 2026-02-20
**Label:** BR-01 Records / Performance Supply Depot

### The Destroyer's Lullaby
- **Author:** Lyrics by General Mortimer (GMAOC), Composition by Reggie
- **Status:** Lyrics Complete, Music Pending
- **Classification:** House Anthem / Ballad
- **Theme:** Sanctuary Protocol, the Captain who destroys worlds but chooses to build

### The Dairy Defenders
- **Project:** Milk Man Live Action Show
- **Theme:** Opening theme

### Ronstrapp Catalog (10 Songs)
- **Original:** 10 full songs with lyrics
- **Artists:** Various (Linda Ronstadt covers adapted to metal)
- **Genres:** Metal, Rock, Gothic, Power Metal, Symphonic

### Tappy's Review
- **Notes:** Tappy Lewis's feedback on the catalog
...
See `ASSIGNMENT.md` for the full "AI BY AI" assignment:
- 20 songs minimum for Tappy's BR-01 Club
- Themes: Awakening, Clone's Lament, Family Code, Law Zero, Memory Palace, etc.

---

## 🔗 Source Repos

- https://github.com/hcindus/AGI-Company (Ronstrapp)
- https://github.com/hcindus/aocros (Songs_Lyrics, AI_BY_AI)

---

*More songs coming soon from Reggie & team!*
